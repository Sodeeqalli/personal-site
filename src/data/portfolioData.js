...
export const siteMeta = {
  title: 'Sodeeq Ayobami - Software and Cloud Engineer',
  description: 'Portfolio of Sodeeq Ayobami, Software and Cloud Engineer focused on scalable products and resilient cloud systems.',
...
export const heroData = {
  scriptName: 'Alli',
  fullName: 'Sodeeq Ayobami',
  role: 'Software Engineer',
  subRoles: ['Software Engineering', 'Solutions Architecture', 'Cloud Engineering', 'Machine Learning & Big Data'],
  location: 'Calgary, AB',
  education: 'MEng @ University of Calgary',
  email: 'sodeeqalli@gmail.com',
}
...
export const socialLinks = [
  {
    id: 'x',
    label: 'X',
    href: 'https://x.com/allisodeeq_',
  },
  {
    id: 'instagram',
    label: 'Instagram',
    href: 'https://www.instagram.com/sodeeq.alli/',
  },
  {
    id: 'discord',
    label: 'Discord',
    href: 'https://discordapp.com/users/sodeeqalli',
  },
  {
    id: 'linkedin',
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/in/sodeeq-alli-94071b267/',
  },
  {
    id: 'credly',
    label: 'Credly',
    href: 'https://www.credly.com/users/sodeeq-alli',
  },
]
